...
class TrainingIntelligenceTests(unittest.TestCase):
    ...
    def test_today_training_modes_show_only_their_workflow(self):
        ...
        self.assertEqual(widget.method_label.text(), "DEATHMATCH PLAN")
        self.assertTrue(widget.start_method_button.isHidden())
        ...
        self.assertEqual(widget.method_label.text(), "ROUTINE")
        self.assertFalse(widget.start_method_button.isHidden())
        ...
        self.assertTrue(widget.settings_frame.isHidden())
        self.assertEqual(widget.method_label.text(), "TRAINING FOCUS")
