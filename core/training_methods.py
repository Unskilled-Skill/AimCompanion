TRAINING_METHODS = [
    ...
    },
    {
        "id": "speed_stopping",
        "mode": "routine",
        "category": "hnA TacFPS Routine",
        "title": "hnA: Speed and stopping",
        "summary": "hnA TacFPS routine for raw acquisition speed and controlled deceleration.",
        ...
        "preferred_routine": "hnA TacFPS Routine - Speed and Stopping",
        "duration": 35
    },
    {
        "id": "speed_precision",
        "mode": "routine",
        "category": "hnA TacFPS Routine",
        "title": "hnA: Speed-to-precision",
        "summary": "hnA TacFPS routine that carries raw speed into disciplined static acquisition.",
        ...
        "preferred_routine": "hnA TacFPS Routine - Speed-to-Precision",
        "duration": 35
    },
    {
        "id": "smooth_pathing",
        "mode": "routine",
        "category": "hnA TacFPS Routine",
        "title": "hnA: Smooth pathing",
        "summary": "hnA TacFPS routine for direct lines, minimal correction, and controlled pursuit.",
        ...
        "preferred_routine": "hnA TacFPS Routine - Smooth Pathing",
        "duration": 35
    },
    {
